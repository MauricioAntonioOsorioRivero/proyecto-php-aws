...
INSERT INTO `comentarios` VALUES (4,'Administrador','asdasdasd asdasd as',2),(5,'Administrador','<script>alert(\"No deberías estar acá, ahora eres responsable de lo que visitarás.\");</script>',2),(6,'Administrador','<script>window.location.href = \"https://www.biobiochile.cl\";</script>',2);
